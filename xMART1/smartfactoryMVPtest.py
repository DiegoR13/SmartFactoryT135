        ...
        while x<l:
            ...
            while wait == True:
                if self.estatus_mision == GoalStatus.SUCCEEDED:
                    ...
                    wait = True
        if (robot.estatus_mision == GoalStatus.SUCCEEDED) and (x==l):
            rospy.sleep(3)
        ...
        while not rospy.is_shutdown():
            ...
            if robot.batterypercentage >= 50:
                if robot.estadoActual == EstadosSMART.Reset:
                    ...
                    robot.rutinaxArm(Rutinas.RecogiendoEnABBPick, EstadosSMART.EnCaminoaAlmacen)
