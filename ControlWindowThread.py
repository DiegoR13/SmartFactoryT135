...
class ControlWindow(threading.Thread):
    ...
    def update(self):
        ...
        self.txtD2Gx1.set(self.srvr.RSx1) ####
        ...
        self.txtD2Gx2.set(self.srvr.RSx2) ###
    ...
    def run(self):
        ...
        LabelxMART1 = Label(self.window, text="xMART 1", font=("Bahnschrift", 20))
        LabelxMART2 = Label(self.window, text="xMART 2", font=("Bahnschrift", 20))
        # LabelOMRON = Label(self.window, text="OMRON", font=("Bahnschrift", 20))
        LabelxMART1.grid(row=3, column=0)
        LabelxMART2.grid(row=4, column=0)
